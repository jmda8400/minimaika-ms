...
class BotSettingsService
{
    ...
    public function get(): array
    {
        ...
        return [
            ...
            'notification_group_id' => trim((string) $settings['notification_group_id']),
            'notification_group_name' => trim((string) $settings['notification_group_name']),
    ...
    public function save(array $settings): void
    {
        ...
        Storage::put(self::PATH, json_encode([
            ...
            'notification_group_id' => trim($settings['notification_group_id']),
            'notification_group_name' => trim($settings['notification_group_name']),
