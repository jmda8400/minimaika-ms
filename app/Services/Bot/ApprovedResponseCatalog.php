...
class ApprovedResponseCatalog
{
     ...
     *
     * @return array<string,array{id:string,topic:string,canonical_question:string,aliases:array<int,string>,approved_answer:string,active:bool,metadata?:array<string,string>}>
     */
    public function all(): array
    {
        $records = [
            ...
            $this->record('answer.lodging_reservation', 'lodging_reservation', '¿Tengo que reservar para dormir?', ['hay que reservar para dormir', 'reservar alojamiento', 'reservar pernocte'], 'Sí, para dormir en el refugio tenés que reservar el pernocte con anticipación desde www.refugiorocca.com.'),
