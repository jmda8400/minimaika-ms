        ...
        <section class="card">
            ...
            <form method="post" action="{{ route('bot.settings.update') }}">
                ...
                <div class="field">
                    ...
                    <div class="options">
                        <label class="option">
                            ...
                            <span><strong>Responder con el bot</strong><br><span class="hint">Usa la base de conocimiento y solo envía respuestas predefinidas cuando corresponden.</span></span>
                        </label>
                        <label class="option">
                            <input type="radio" name="response_mode" value="default" @checked(old('response_mode', $settings['response_mode']) === 'default')>
                            <span><strong>Responder con mensaje por defecto</strong><br><span class="hint">IA desactivada y envío del texto configurado abajo.</span></span>
                        </label>
                    </div>
                ...
                <div class="field">
                    ...
                    <p class="hint">Texto enviado con el modo “Responder con mensaje por defecto”.</p>
                ...
                <div class="field">
                    <label class="checkbox">
                        ...
                        <span><strong>Responder también en grupos de WhatsApp</strong><br><span class="hint">Desactivado: solo mensajes directos de clientes.</span></span>
                    </label>
