...
- El gateway debe exponer endpoints compatibles con:
  ...
  - `POST /message/sendButtons/{instance}` para botones de respuesta. Como WhatsApp admite hasta tres botones de respuesta por mensaje, los menús largos se dividen en grupos de tres. Si el gateway o su versión rechazan este endpoint, el bot registra el error y envía automáticamente el mismo menú como una lista numerada.
